...
# Constants
LUX_DLL_NAME = "TestModule1.dll"
LUX_FINAL_NAME = "TestModule1.Lux.dll"
LUX_MOD_FOLDER = "TestModule1"
SOURCE_DIR = "./TestModule1/bin/Debug/net9.0-windows10.0.26100.0/publish"
