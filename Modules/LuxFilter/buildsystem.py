...
# Constants
LUX_DLL_NAME = "LuxFilter.dll"
LUX_FINAL_NAME = "LuxFilter.Lux.dll"
LUX_MOD_FOLDER = "LuxFilter"
SOURCE_DIR = "./LuxFilter/bin/Release/net9.0-windows10.0.26100.0/" + current_arch + "/publish"
DEST_DIR = "../../Luxoria.App/Luxoria.App/bin/" + short_arch + "/Release/net9.0-windows10.0.26100.0/" + current_arch + "/modules/" + LUX_MOD_FOLDER
MODULE_SOURCE_DIR = "./LuxFilter/bin/Release/net9.0-windows10.0.26100.0/" + current_arch + "/LuxFilter"
MODULE_DEST_DIR = "../../Luxoria.App/Luxoria.App/bin/" + short_arch + "/Release/net9.0-windows10.0.26100.0/" + current_arch + "/LuxFilter"
