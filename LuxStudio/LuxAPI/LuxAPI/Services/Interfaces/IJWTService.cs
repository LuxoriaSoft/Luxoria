...
namespace LuxAPI.Services.Interfaces
{
    ...
    public interface IJwtService
    {
        ...
        /// <param name="role">User role (Client or Photographer)</param>
        /// <param name="expiryHours">ExpiryHours as Int (default = 48h)</param>
        /// <returns>Returns the token as String</returns>
        string GenerateJwtToken(Guid userId, string username, string email, UserRole role, int expiryHours = 48);
    }
}
