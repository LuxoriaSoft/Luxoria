...
namespace Luxoria.Modules.Tests.Models.Events
{
    public class OpenCollectionEventTests
    {
        ...
        public void Constructor_ShouldSetPathProperty()
        {
            ...
            // Act
            var openCollectionEvent = new OpenCollectionEvent(expectedPath);

            // Assert
            Assert.Equal(expectedPath, openCollectionEvent.Path);
        }
        ...
        {
            // Arrange
            var openCollectionEvent = new OpenCollectionEvent("test/path");
